...
[source,terminal]
----
oc get pods -n <idp-installation-namespace>
----
note the pod's name and then run
+
[source,terminal]
----
oc logs -n <idp-installation-namespace> <pod-name>
----
A message similar to the following means the prerequise are not met.
+
[source,terminal]
----
