...
*Note:* Only OpenShift Container Platform 4.9 or 4.8.12 and higher is supported for the hub.  For 4.8, a minimum of 4.8.12 is required due to https://bugzilla.redhat.com/show_bug.cgi?id=1969902[Bugzilla 1969902]. 
