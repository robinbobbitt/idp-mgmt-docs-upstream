...
. You must delete the IDPConfig CR, this will delete the different operators except the installer. The installed will be deleted when you delete the identity configuration management from the OperatorHub.
